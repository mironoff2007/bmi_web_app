...
var author$project$GetTable$Loading = {$: 'Loading'};
...
var author$project$GetTable$Success = function (a) {
	return {$: 'Success', a: a};
};
	...
	return elm$http$Http$request(
		{
			...
			expect: A2(elm$http$Http$expectJson, author$project$GetTable$GotBmi, author$project$GetTable$bmiListDecoder),
			headers: _List_Nil,
			method: 'GET',
		...
		if (msg.$ === 'GotBmi') {
			...
			if (result.$ === 'Ok') {
				...
				return _Utils_Tuple2(
					author$project$GetTable$Success(bmis),
...
var author$project$GetTable$viewBmi = function (bmi) {
	return A2(
		elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
...
var author$project$GetTable$viewTableHeader = A2(
	elm$html$Html$tr,
	_List_Nil,
	_List_fromArray(
		[
...
var author$project$GetTable$viewBmis = function (bmis) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_Utils_ap(
					_List_fromArray(
						[author$project$GetTable$viewTableHeader]),
					A2(elm$core$List$map, author$project$GetTable$viewBmi, bmis)))
			]));
};
var author$project$GetTable$viewBmiTable = function (state) {
	switch (state.$) {
		case 'Failure':
			return A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						elm$html$Html$text('I could not load  ')
					]));
		case 'Loading':
			return A2(
				elm$html$Html$div,
		...
		case 'Success':
			...
			return A2(
				...
				_List_fromArray(
					[
						author$project$GetTable$viewBmis(bmis)
					]));
		default:
			var str = state.a;
...
var author$project$GetTable$view = function (state) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				author$project$GetTable$viewBmiTable(state)
			]));
};
...
var author$project$GetTable$main = elm$browser$Browser$element(
	{init: author$project$GetTable$init, subscriptions: author$project$GetTable$subscriptions, update: author$project$GetTable$update, view: author$project$GetTable$view});
_Platform_export({'GetTable':{'init':author$project$GetTable$main(
