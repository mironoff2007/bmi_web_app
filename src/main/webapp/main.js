...
var author$project$Main$GotBmi = function (a) {
	return {$: 'GotBmi', a: a};
};
var author$project$Main$Bmi = F3(
...
var author$project$Main$bmiDecoder = A4(
	elm$json$Json$Decode$map3,
	author$project$Main$Bmi,
...
var author$project$Main$viewGif = function (state) {
	switch (state.$) {
		case 'Failure':
			return A2(
				elm$html$Html$div,
...
var author$project$Main$view = function (state) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$viewGif(state)
			]));
};
